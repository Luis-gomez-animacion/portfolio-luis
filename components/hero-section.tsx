      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          ...
          <div className="hero-in hero-in-5 flex flex-col sm:flex-row flex-wrap gap-4 pt-4">
            ...
            <Button
              variant="outline"
              className="bg-transparent text-foreground border-2 border-foreground hover:bg-foreground hover:text-background rounded-none py-5 px-8 md:py-[22px] md:px-[52px] text-base md:text-lg font-bold uppercase tracking-wide h-auto w-full sm:w-auto transition-transform duration-300 ease-overshoot hover:scale-[1.03]"
              asChild
            >
              <a href="#proyectos">
