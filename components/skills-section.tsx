        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <div
                key={index}
                className="bg-card border-2 border-foreground rounded-none overflow-hidden hover:translate-y-[-4px] hover:shadow-[8px_8px_0px_0px_var(--brutal-lime)] transition-all duration-300 min-h-[280px] flex flex-col group"
              >
                <div
                ...
                <div className="px-8 py-6 flex-1 flex flex-col">
                  <h3 className="text-[24px] leading-[32px] font-bold mb-3 text-foreground">{skill.title}</h3>
                  <p className="text-[16px] leading-[26px] font-medium text-muted-foreground">{skill.description}</p>
                </div>
              </div>
            ))}

            <div className="bg-[#0B0B0B] border-2 border-foreground rounded-none p-8 md:p-10 flex flex-col items-center justify-center text-center hover:translate-y-[-4px] transition-transform min-h-[280px] relative shadow-[8px_8px_0px_0px_var(--brutal-magenta)]">
