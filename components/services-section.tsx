        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#FFC224] border-2 border-foreground rounded-none p-8 md:p-12 flex flex-col items-center justify-center text-center hover:translate-y-[-4px] transition-transform min-h-[480px] relative shadow-[8px_8px_0px_0px_var(--brutal-lime)]">
              ...
              <h3 className="text-[28px] leading-[40px] font-bold mb-4 text-foreground">Hablemos</h3>
              <p className="text-[18px] leading-[30px] font-medium text-muted-foreground mb-8">
                ¿Buscás otro servicio? Contactame, hay muchas chances de que pueda ayudarte con tu proyecto.
              </p>
              <Button
                className="bg-brutal-lime text-[#110f0c] hover:bg-brutal-lime/90 border-2 border-foreground rounded-none px-12 py-6 font-medium text-[18px] w-full max-w-[340px] h-[64px]"
                asChild
              >
