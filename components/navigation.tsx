  ...
  return (
    <div className="container mx-auto px-4 pt-8 pb-4">
      <nav className="flex items-center justify-between bg-card border-2 border-foreground px-5 py-3 max-w-2xl mx-auto hard-shadow-sm">
        <div className="w-10 h-10 bg-brutal-lime border-2 border-foreground flex items-center justify-center flex-shrink-0 text-[#110f0c] font-bold text-sm font-display">
          LG
        </div>

        <div className="hidden md:flex items-center gap-6 flex-1 justify-center font-mono uppercase text-sm tracking-wide">
          <a href="#inicio" className="font-bold hover:text-brutal-lime transition-colors">
            Inicio
          </a>
          <a href="#sobre-mi" className="font-bold hover:text-brutal-lime transition-colors">
            Sobre mí
          </a>
          <a href="#proyectos" className="font-bold hover:text-brutal-lime transition-colors">
            Proyectos
          </a>
          <a href="#experiencia" className="font-bold hover:text-brutal-lime transition-colors">
            Experiencia
          </a>
        </div>
