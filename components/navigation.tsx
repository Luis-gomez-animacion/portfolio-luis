  ...
  return (
    <div className="container mx-auto px-4 pt-8 pb-4">
      <nav className="flex items-center justify-between bg-card border-2 border-foreground px-5 py-3 max-w-2xl mx-auto hard-shadow-sm">
        <Link
          href="/"
          className="w-10 h-10 bg-brutal-lime border-2 border-foreground flex items-center justify-center flex-shrink-0 text-[#110f0c] font-bold text-sm font-display transition-transform duration-300 ease-overshoot hover:rotate-[-8deg] hover:scale-110"
        >
          LG
        </Link>
