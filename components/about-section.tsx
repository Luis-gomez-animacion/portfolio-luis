    ...
    <section id="sobre-mi" className="container mx-auto px-4 py-16 md:py-32">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-foreground rounded-full overflow-hidden bg-[#6366F1] shadow-[-8px_8px_0px_0px_var(--brutal-lime)]">
            <img
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              <div className="w-5 h-5 bg-[#6366F1] border-2 border-foreground rounded-[5px] flex-shrink-0 mt-1"></div>
              <div>
            ...
            <div className="flex gap-4 items-start">
              <div className="w-5 h-5 bg-[#FF6B7A] border-2 border-foreground rounded-[5px] flex-shrink-0 mt-1"></div>
              <div>
            ...
            <div className="flex gap-4 items-start">
              <div className="w-5 h-5 bg-[#FFC224] border-2 border-foreground rounded-[5px] flex-shrink-0 mt-1"></div>
              <div>
          ...
          <Button
            className="bg-brutal-lime text-[#110f0c] hover:bg-brutal-lime/90 border-2 border-foreground rounded-none py-5 px-8 md:py-[22px] md:px-[62px] text-base md:text-lg font-semibold h-auto w-full sm:w-auto sm:min-w-[240px]"
            asChild
          >
