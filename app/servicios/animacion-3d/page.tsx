...
export const metadata = {
  title: "Animación 3D & Rigging - Luis Gómez",
  description: "Videos de animación 3D, modelado y rigging de Luis Gómez.",
}

const videos = [
  {
    title: "Vertical Fuxia",
    description: "Animación 3D en formato vertical, movimiento de cámara y composición en clave fucsia.",
    src: "/videos/motion3d-vertical.mp4",
  },
]

export default function Animacion3DPage() {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12 md:mb-16">
              <h1 className="text-4xl md:text-[52px] md:leading-[60px] mb-4">
                <span className="bg-brutal-magenta text-[#110f0c] px-3 py-1 inline-block">Animación 3D & Rigging</span>
              </h1>
              <p className="text-muted-foreground text-base md:text-lg font-medium leading-relaxed md:leading-[30px] max-w-2xl">
                Modelado, rigging y animación 3D en Blender. Creación de personajes y dioramas animados para YouTube,
                VR e instalaciones inmersivas.
              </p>
            </div>
            ...
            <div className="mt-12 bg-[#FFC224] border-2 border-foreground rounded-none p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[8px_8px_0px_0px_var(--brutal-lime)]">
              <div>
                <h3 className="text-[24px] leading-[32px] font-bold mb-2 text-[#110f0c]">
                  ¿Te interesa un proyecto de animación 3D?
                </h3>
